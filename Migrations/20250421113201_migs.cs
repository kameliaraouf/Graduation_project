        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Qustion = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "users",
                columns: new[] { "UserID", "Email", "FirstName", "LastName", "Password", "Phone", "Role", "UserName" },
                values: new object[] { 1, "", "", "", "$2a$10$gxPoIhi3KkMKlc5Cexy0g.PBcU6PBFwpqqGPiYLSo9AfgxE2V6hqC", "", "Admin", "admin" });
